...
namespace expose {
    ...
    using namespace shyft::core::universal_snow;
    using namespace boost::python;
    using namespace std;
    void universal_snow() {
        class_<parameter>("UniversalSnowParameter")
            ...
            ;
        class_<state>("UniversalSnowState", "The state description of the UniversalSnow routine")
          ...
          ;
        class_<response>("UniversalSnowResponse","The response(output) from gamma-snow for one time-step")
          ...
          ;
        typedef calculator<parameter,state,response> UniversalSnowCalculator;
        class_<UniversalSnowCalculator>("UniversalSnowCalculator")
            .def("step",&UniversalSnowCalculator::step,args("state","response","t","dt","parameter","temperature","radiation","precipitation","wind_speed","rel_hum","forest_fraction","altitude"),
