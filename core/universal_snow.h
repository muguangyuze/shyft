#pragma once
///    Copyright 2017 Statkraft Energi A/S
///
        ...
        namespace universal_snow {
            ...
            struct calculator {
                ...
                void step(S& s, R& r, shyft::time_series::utctime t, shyft::time_series::utctimespan dt,
                    ...
                    if (snow < universal_snow::tol && sdc_melt_mean < universal_snow::tol && acc_melt < 0.0) { // Early autumn scenario, no snow
                    ...
                    if (T > 0.0 && snow < universal_snow::tol) // Why not if (rain > 0.0)?
                        effect += rain*T*water_heat/(double)dt;
                    if (T <= 0.0 && rain < universal_snow::tol)
                    ...
                    if (acc_melt < 0.0) {
                        if (snow < universal_snow::tol) snow = 0.0;
                        else {
                            ...
                            if (lwc > 0.0 && sdc_snow > 0.01*sdc_melt_mean) {
                                ...
                                if (z1_guess < universal_snow::tol)
                                    z1_guess = z1*0.5;
                        ...
                        if (temp_swe > 0.0) {
                            ...
                            potential_melt -= melt;
                            lwc += melt;
                            if (temp_swe < universal_snow::tol) temp_swe = 0.0;
                        }
...
x_serialize_export_key(shyft::core::universal_snow::state);
